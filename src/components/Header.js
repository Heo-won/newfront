    ...
    <div className="out">
      <header className="header">
        <div className="brand">
          ...
          {show && (<ul class="sidenav">
            <li><Link to="/api/compare">메뉴</Link></li>
            <li><Link to="/api/event">이벤트</Link></li>
            <li><Link to="/api/board">커뮤니티</Link></li>
            <li><Link to="/api/store">스토어</Link></li>
            <li><Link to="/api/qna">고객 센터</Link></li>
          </ul>)}
          <Link to="/">
            <MyDiv>
